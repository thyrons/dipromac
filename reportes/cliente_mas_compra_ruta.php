<?php
    ...
    {   
        ...
        function Header(){             
            ...
            $this->Cell(190, 5, utf8_decode("VENTAS POR CLIENTES QUE MAS COMPRAN POR RUTA "),0,1, 'C',0);                                          
            $this->SetFont('Amble-Regular','',10);                                                                             
