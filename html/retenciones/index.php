                        ...
                        <div class="span12">      		
                            <div class="widget ">
                                ...
                                <div class="widget-content">
                                 <form class="form-horizontal" id="impuesto_form" name="retencion_form" method="post">
                                    <div class="row">
                                       <div class="span6">
                                       ...
                                       <div class="span6">
                                          ...
                                          <div class="tab-content">
                                             <div class="tab-pane active" id="formcontrols">
                                                ...
                                                <div class="control-group">                                           
                                                    <label class="control-label" for="valor">Valor Base $:</label>
                                                    <div class="controls">
                                                         <input type="text" name="valor_base" id="valor_base" class="span2" value="" />
                                                    </div>
                                                </div>
                                             </div> 
