...
function modificar(){
if($("#id_segundo_impuesto").val() == ""){
   $("#id_segundo_impuesto").focus();
...
function inicio() {
    ...
    jQuery("#list").jqGrid({
        ...
        colModel: [
            {name: 'id_segundo_impuesto', index: 'id_segundo_impuesto',hidden: true, editable: true, align: 'center', width: '120', search: false, frozen: true, editoptions: {readonly: 'readonly'}, formoptions: {elmprefix: ""}},
        ...
        ondblClickRow: function(){
            ...
            $("#id_segundo_impuesto").val(ret.id_segundo_impuesto);
